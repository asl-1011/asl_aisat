...
export default function TeamList() {
    ...
    const teamElements = useMemo(() => teams.map((team) => (
        <motion.div
            key={team._id}
        ...
        >
            <img src={`/api/teams/logo/${team.team_logo}`} alt={team.team_name} className="w-16 h-16 rounded-full" loading="lazy" />
            <div>
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="text-center">
                                <img src={`/api/teams/logo/${selectedTeam.team_logo}`} alt={selectedTeam.team_name} className="w-24 h-24 mx-auto rounded-full" loading="lazy" />
                                        ...
                                        {selectedTeam.players.length > 0 ? (
                                            selectedTeam.players.map((player) => (
                                                <motion.div 
                                                    ...
                                                    whileHover={{ scale: 1.02 }}
                                                >
                                                    <img src={`/api/teams/logo/${player.profilePic}`} alt={player.name} className="w-12 h-12 rounded-full" loading="lazy" />
                                                    <div>
